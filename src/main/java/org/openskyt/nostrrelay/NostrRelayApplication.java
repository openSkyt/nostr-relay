...
public class NostrRelayApplication implements CommandLineRunner {
	...
	public void run(String... args) {
		...
		repo.save(new Event("id6", "pubkey1", System.currentTimeMillis() / 1000, 1, new String[][]{}, "content6", "sig6"));
		repo.save(new Event("id7", "pubkey1", System.currentTimeMillis() / 1000, 1, new String[][]{}, "content7", "sig7"));
		repo.save(new Event("id8", "pubkey2", System.currentTimeMillis() / 1000, 1, new String[][]{}, "content8", "sig8"));
		repo.save(new Event("id9", "pubkey2", System.currentTimeMillis() / 1000, 1, new String[][]{}, "content9", "sig9"));
	}
}

...
class EventSigValidatorTest {
    ...
    @Test
    void verifyEvent() {
        Assertions.assertTrue(eventSigValidator.verifyEvent(new EventData(new Event("2786e0e7179f3a4eec632df6595b20c8ce7d146fcd201194c562f1ce7df7513d",
    ...
    void verifyEventBadInput() {
        Assertions.assertFalse(eventSigValidator.verifyEvent(new EventData(new Event("1234",
                "a23cceb5d5596f80c3249f15ebcf3e42c6aba0b3c88aaf572c018bb6c7e6180c",
                1705579214,
                1,
                new String[][]{},
